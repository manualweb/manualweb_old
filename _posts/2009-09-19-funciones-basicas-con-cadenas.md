...
<pre>r (114) &gt; n(110)</pre> Y nos devolverá la resta de sus valores. En este caso un 4. Hay que tener cuidado, porque este método no tiene en cuenta las mayúsculas y minúsculas. Y dichos caracteres, aún siendo iguales, tienen diferentes código. Veamos la siguiente comparación 
...
<pre>R(82) &lt; r(114)</pre> ¿Qué entero nos devolverá el método compareTo()? ¿-32? 
...
<pre>String s = "Víctor Cuervo"</pre> El método… 

<pre>s.substring(7)</pre> Nos devolverá “Cuervo”. 
...
<pre>String s = "En un lugar de la mancha...."</pre> El método... 

<pre>s.substring(6,11)</pre> Nos devolverá la palabra “lugar”. 
